...
namespace WorkFlow.UnitTests.Application.Projects.StartProject;

public sealed class StartProjectHandlerTests
{
    [Fact]
    public async Task
    HandleAsync_ShouldStartProject_WhenRequesterIsTenantAdmin()
    {
        var fixture =
            CreateFixture(
    ...
    public async Task
    HandleAsync_ShouldStartProject_WhenRequesterHasEditProjectPermission(
        UserRole role)
    {
        var fixture =
            CreateFixture(
    ...
    [Fact]
    public async Task
    HandleAsync_ShouldReturnFailure_WhenProjectIsNotPlanning()
    {
        var fixture =
            CreateFixture(
                UserRole.TenantAdmin);
    ...
    private static StartProjectCommand CreateCommand(
        Fixture fixture)
    {
