...
namespace WorkFlow.UnitTests.Application.Projects.ResumeProject;

public sealed class ResumeProjectHandlerTests
{
    [Fact]
    public async Task
    HandleAsync_ShouldResumeProjectAndKeepDueDate_WhenNewDueDateIsNull()
    {
        var fixture =
            CreateFixture(
    ...
    [Fact]
    public async Task
    HandleAsync_ShouldResumeProjectAndChangeDueDate_WhenNewDueDateIsProvided()
    {
        var fixture =
            CreateFixture(
                UserRole.TenantAdmin);
    ...
    public async Task
    HandleAsync_ShouldResumeProject_WhenRequesterHasEditProjectPermission(
        UserRole role)
    {
        var fixture =
            CreateFixture(
    ...
    [Fact]
    public async Task
    HandleAsync_ShouldReturnFailure_WhenProjectIsNotPaused()
    {
        var fixture =
            CreateFixture(
                UserRole.TenantAdmin);

        fixture.Project.Resume();
    ...
    private static ResumeProjectCommand CreateCommand(
        Fixture fixture,
        DateTime? newDueDate)
    {
        return new ResumeProjectCommand(
            fixture.Tenant.PublicId,
            fixture.Project.PublicId,
            fixture.Requester.PublicId,
            newDueDate);
